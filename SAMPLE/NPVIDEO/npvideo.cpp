...
NPP_Destroy(NPP instance, NPSavedData** save)
{
    ...
    if (This != 0   )
    {
        ...
        // delete video canvas and video device
        if (This->video)
        {
           delete This->video;
           This->video = 0;
...
NPP_StreamAsFile(NPP instance, NPStream *stream, const char* fname)
{
   ...
   try
   {
      This->vidPlayer = new IMMDigitalVideo();
   }
   catch (...)
   {
      This->vidPlayer = 0;
   ...
   This->video = new VIDEO(This->vidPlayer, This->win->size(), VIDEO_ID,
                           IString(fname), This->win, This->win);
   if (!This->vidPlayer)
      ((IMultiCellCanvas*)This->video)->disable();
   This->video->sizeTo(This->win->size());
   This->video->show();
   This->video->setFocus();
   This->vidPlayer->stepFrame(1, true);
   This->vidPlayer->stepFrame(1, false);
   This->video->getVideoCanvas().show();
   This->video->getVideoCanvas().setFocus();
   This->video->refresh();
   This->video->getVideoCanvas().refresh();
